    ...
    return (
        <div className='about'>
            ...
            <p className='lh-base'>
                ...
                When the pandemic began, I decided to broaden my skillsets and took the plunge into learning web development. I am a certified full-stack web developer with experience
